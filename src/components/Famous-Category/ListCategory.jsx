            ...
            <AnimatePresence key={index}>
              ...
              >
                <div
                  ...
                  className="imgAndText flex w-[75%] items-center gap-2 xl:w-[70%] 2xl:w-[80%] lg:w-[70%]"
                >
                  <img
                ...
                <button className="flex h-[3rem] min-w-[3.5rem] cursor-pointer items-center justify-center">
