...
const HomePageCategory = () => {
  ...
  return (
    <section className="m-auto relative h-fit my-3 w-[97vw] sm:my-6 md:max-w-[75vw]">
      <div className="gap-2 flex bg-white dark:bg-main-dark py-1.5 sticky sm:top-[6rem] top-[6.5rem] md:top-[9rem] z-10">
      ...
      <div className="displayCategory my-2">
        ...
        >
          {category.map((Item, index) => {
            return (
              <li key={index} className="h-fit p-2 border border-theme-light xl:w-[24%] lg:w-[32.2%] md:w-[31.8%] w-[48%] rounded-md items-center justify-center flex flex-col bg-[#f0f3f5] dark:bg-[#1e1e1e] dark:border-[#2d2d2d] dark:border-2">
