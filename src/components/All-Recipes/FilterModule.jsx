  ...
  return (
    <div className="w-full h-fit">
      ...
      <div
        ...
        bg-[#f3f3f7] rounded-t-3xl p-4 
        w-full md:max-w-[75vw] mx-auto 
        max-h-[66vh] overflow-y-auto`}
      >
        <div className="w-full">
          <div className="flex justify-between items-center mb-2">
            <h2 className="font-semibold text-[1.5rem]">Recipe Filter</h2>
            <button
              className="bg-gray-200 p-1 rounded-full"
              onClick={toggleDrawer}
            >
              <IoClose className="text-gray-800 text-[1.5rem]" />
            </button>
          </div>

          <div className="border-b border-dashed border-gray-400 mb-4" />

          <div className="filterData gap-2 flex flex-col">
            <FilterSheet />
          </div>
        </div>
      </div>
